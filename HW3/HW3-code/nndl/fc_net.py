...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    out, l1_cache = affine_relu_forward(X, self.params['W1'], self.params['b1'])
    scores, l2_cache = affine_forward(out, self.params['W2'], self.params['b2'])
    ...
    dh1, grads['W2'], grads['b2'] = affine_backward(dL, l2_cache)
    dx,  grads['W1'], grads['b1'] = affine_relu_backward(dh1, l1_cache)
